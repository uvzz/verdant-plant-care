...
const es: Messages = {
  ...
  'insights.aiTitle': 'Análisis de IA de tu colección',
  'insights.aiBodyPremium':
    'Una nota breve de coaching según tus datos. IA Premium · te quedan ~{usesLeft} usos hoy en este dispositivo.',
  'insights.aiBodyFree':
    'Solo Premium — actívala en Ajustes para una nota de coaching tranquila sobre tu colección.',
  'insights.aiButtonGenerate': 'Generar análisis',
  ...
  'insights.alertInsightFailedTitle': 'Error al generar el análisis',
...
const fr: Messages = {
  ...
  'domain.pet.safe': 'Animaux : sans danger',
  'domain.pet.caution': 'Animaux : prudence',
  'domain.pet.toxic': 'Animaux : toxique',
  ...
  'calendar.swipeFed': 'Fertilisée',
  'calendar.toastWatered': 'Arrosage noté · {name}',
  'calendar.toastFed': 'Fertilisation notée · {name}',
  ...
  'insights.aiTitle': 'Analyse IA de la collection',
  'insights.aiBodyPremium':
  ...
  'insights.aiButtonGenerate': 'Générer l’analyse',
  ...
  'insights.alertInsightFailedTitle': 'Impossible de générer l’analyse',
  ...
  'detail.heroMetaAge': '{category} · {age}',
  'detail.heroMetaLocationAge': '{category} · {location} · {age}',
  'detail.heroAgeOne': '1j avec vous',
...
const de: Messages = {
  ...
  'insights.aiBodyPremium':
    'Eine kurze Coaching-Notiz zu deinen Daten. Premium-KI · noch ca. {usesLeft} Anfragen heute auf diesem Gerät.',
  'insights.aiBodyFree':
  ...
  'detail.deleteAlertBody':
    '{name} und den zugehörigen Pflegeverlauf löschen? Das kann nicht rückgängig gemacht werden.',
