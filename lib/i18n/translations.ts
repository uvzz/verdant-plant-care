...
const fr: Messages = {
  ...
  'domain.pet.safe': 'Sans danger pour les animaux',
  'domain.pet.caution': 'Animaux : prudence',
  'domain.pet.toxic': 'Toxique pour les animaux',
  'domain.careType.water': 'Arrosée',
  'domain.careType.fertilize': 'Fertilisée',
  'domain.careType.note': 'Note',
  'domain.careType.photo': 'Photo',
  'domain.careType.check': 'Contrôle du sol',
...
const de: Messages = {
  ...
  'domain.light.bright': 'Helles Indirektlicht',
  ...
  'domain.careType.photo': 'Foto',
  'domain.careType.check': 'Bodencheck',
